(function ($) {
  ...
  if ($(".main-slider__carousel").length > 0) {
    var bannerSlider = new Swiper(".main-slider__carousel", {
      effect: "fade",
      spaceBetween: 0,
      slidesPerView: 1,
      mousewheel: false,
  ...
  //=== CountDownTimer===
  if ($('.discount-one-countdown').length) {
    $('.discount-one-countdown').each(function () {
      var Self = $(this);
  ...
  if ($(".mobile-nav__toggler").length) {
    $(".mobile-nav__toggler").on("click", function (e) {
      ...
      // Hide patient form when mobile menu opens on mobile devices
      if ($(window).width() < 768) {
        $(".patient-form-sticky").toggleClass("hidden-on-mobile-menu");
      }
    });
  }
  ...
  //================================================================//
  // Main Service One Carousel//
  //================================================================//
  if ($(".main-service-one__carousel").length > 0) {
    var mainserviceoneSlider = new Swiper(".main-service-one__carousel", {
      spaceBetween: 24,
      slidesPerView: 3,
      mousewheel: false,
      height: 500,
      ...
      navigation: {
        prevEl: ".main-service-one__nav-prev",
        nextEl: ".main-service-one__nav-next",
      },
      breakpoints: {
        0: {
          slidesPerView: 1,
  ...
  //================================================================//
  if ($(".service-three__carousel").length > 0) {
    var servicethreeSlider = new Swiper(".service-three__carousel", {
      spaceBetween: 24,
      slidesPerView: 3,
      mousewheel: false,
      height: 500,
      ...
      navigation: {
        prevEl: ".service-three__nav-prev",
        nextEl: ".service-three__nav-next",
      },
      breakpoints: {
        0: {
          slidesPerView: 1,
  ...
  //================================================================//
  // Partners One Carousel//
  //================================================================//
  if ($(".partners-one__carousel").length > 0) {
    var partnersoneSlider = new Swiper(".partners-one__carousel", {
      spaceBetween: 24,
      slidesPerView: 6,
      mousewheel: false,
      height: 500,
      ...
      navigation: {
        prevEl: ".partners-one__nav-prev",
        nextEl: ".partners-one__nav-next",
      },
      breakpoints: {
        0: {
          slidesPerView: 1,
