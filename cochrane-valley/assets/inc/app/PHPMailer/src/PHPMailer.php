...
class PHPMailer
{
    ...
    {
        //Verify we have required functions, CharSetand at-sign.
        $pos = strrpos($address, '@');
        if (
            !empty($this->CharSet) &&
            false !== $pos &&
            ...
            //Verify CharSet string is a valid oneand domain properly encoded in this CharSet.
    ...
    public function preSend()
    {
        ...
        try {
            ...
            //Validate From, Senderand ConfirmReadingTo addresses
    ...
    /**
     * Check whether a file path is safe, accessibleand readable.
     *
     * @param string $path A relative or absolute path to a file
     *
     * @return bool
    ...
    public function createBody()
    {
        ...
        //If lines are too longand we're not already using an encoding that will shorten them,
    ...
    /**
     * Attach all file, stringand binary attachments to the message.
     * Returns an empty string on failure.
     *
     ...
     * This can include images, soundsand just about any other document type.
    ...
    /**
     * Clear all filesystem, stringand binary attachments.
     */
    ...
    public function addCustomHeader($name, $value = null)
    {
        ...
        //Ensure name is not emptyand that neither name nor value contain line breaks
