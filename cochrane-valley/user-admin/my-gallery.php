...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if ($stmt->execute()) {
        ...
        $msg = "Failed to delete gallery item.";
        $msg_type = "danger";
    }
    $stmt->close();
}
...
<main class="main-content">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold">My Gallery</h3>
            <a href="create-gallery-item.php" class="btn btn-primary">
        ...
        <?php if (empty($items)): ?>
            <div class="alert alert-info">No gallery images found. Start by uploading one!</div>
        <?php else: ?>
            <div class="row">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto d-flex justify-content-end">
                                <a href="my-gallery.php?delete=<?php echo $item['id']; ?>" 
